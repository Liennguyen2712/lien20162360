...
// export class HrManagerKpiAddOrEditComponent extends BaseAddOrEditComponent<Kpi, KpiFilterModel, KpiService> implements OnInit {
...
//     this._dataService.updateKpiSendCorLeader(this.item).then(
//       async (data) => {
...
//   getReadOnlyFilter() {
//     const readonlyFilter: KpiReadOnlyFilter = { className: 'HrManagerKpiAddOrEditComponent', kpiStatus: this.item.statusId };
